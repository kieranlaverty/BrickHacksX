...
def main():
   ...
   with mp_holistic.Holistic(min_detection_confidence = .5, min_tracking_confidence=.5) as holistic:
      with mp.tasks.vision.GestureRecognizerOptions(BaseOptions, min_hand_detection_confidence = 0.5, min_hand_presence_confidence= 0.5) as gesture:
         ...
         while True:
            ...
            result = gesture.process(RGB_frame)
            mp_drawing.draw_landmarks(frame, result.pose_landmarks, mp_holistic.POSE_CONNECTIONS)
